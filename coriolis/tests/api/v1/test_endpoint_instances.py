...
class EndpointInstanceControllerTestCase(
    ...
    def setUp(self):
        super(
            EndpointInstanceControllerTestCase,
            self
        ).setUp()
        self.endpoint_api = \
            endpoint.EndpointInstanceController()
    ...
    def test_index(
        ...
        mock_get_paging_params.assert_called_with(mock_req)
