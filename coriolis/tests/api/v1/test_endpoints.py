...
class EndpointControllerTestCase(
    ...
    def test_show(
        ...
        mock_get_endpoint,
        mock_single,
        mock_get_endpointss_policy_label,
    ):
        mock_req = mock.Mock()
        ...
        mock_get_endpointss_policy_label.assert_called_once_with("show")
    ...
    def test_index(
        ...
        mock_get_endpointss_policy_label.assert_called_once_with("list")
    ...
    def test_create(
        self,
        mock_get_endpoints_policy_label,
        ...
        mock_get_endpoints_policy_label.assert_called_once_with("create")
    ...
    def test_update(
        ...
        mock_get_endpoints_policy_label.assert_called_once_with("update")
    ...
    def test_delete(
        ...
        mock_get_endpoints_policy_label.assert_called_once_with("delete")
